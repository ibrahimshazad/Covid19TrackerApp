...
class GlobalStatistics extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        buildCard("Total Confirmed", summary.totalConfirmed,
        ...
        buildCard(
            ...
            kActiveColor),
        buildCard("Total Recovered", summary.totalRecovered,
            summary.newRecovered, kRecoveredColor),
        buildCard("No. of Deaths", summary.totalDeaths, summary.newDeaths,
            kDeathColor),
        Padding(
